...
import { type DigitalAdoption } from './types'
import featureFlags from '@/lib/feature-flags'
import config from '@/lib/config'
import { mock } from './mock'

const BASE_URL = config.services.accountManagement + '/v1/accounts/digital-adoption-summary'
...
const useRead = (options = {}) => {
  ...
  return {
    ...response,
    data: (response.data) as ApiResponse<DigitalAdoption> | undefined
  }
}
